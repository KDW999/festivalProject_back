...
public class FestivalController {
    ...
    public ResponseDto<PostFestivalResponseDto> postFestival(@AuthenticationPrincipal String userId,@Valid @RequestBody PostFestivalRequestDto requestBody){
        ResponseDto<PostFestivalResponseDto> response = festivalService.postFestival(userId, requestBody);
        return response;
