...
public class GetFestivalReviewBoardListResponseDto {
    ...
    public GetFestivalReviewBoardListResponseDto(BoardEntity boardEntity){
    ...
    public static List<GetFestivalReviewBoardListResponseDto>copyList(List<BoardEntity> boardEntityList){
        List<GetFestivalReviewBoardListResponseDto> list =new ArrayList<>();

        for(BoardEntity boardEntity:boardEntityList){
            GetFestivalReviewBoardListResponseDto dto = new GetFestivalReviewBoardListResponseDto(boardEntity);
            list.add(dto);
        }
